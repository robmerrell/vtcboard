...
func RenderFloatFromString(format, n string) string {
	converted, _ := strconv.ParseFloat(n, 64)
	return RenderFloat(format, converted)
}
...
func RenderIntegerFromString(format, n string) string {
	...
	return RenderInteger(format, converted)
}
